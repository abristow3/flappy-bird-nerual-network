...
class NeuralNet:
    ...
    def modify_weights(self):
        NeuralNet.modify_array(self.weight_input_hidden)
        NeuralNet.modify_array(self.weight_hidden_output)

    def create_mixed_weights(self, net1, net2):
        self.weight_input_hidden = NeuralNet.get_mix_from_arrays(net1.weight_input_hidden, net2.weight_input_hidden)
        self.weight_hidden_output = NeuralNet.get_mix_from_arrays(net1.weight_hidden_output, net2.weight_hidden_output)
